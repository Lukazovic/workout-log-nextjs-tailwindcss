...
describe('<Heading />', () => {
  ...
  it('should render a h2 heading', () => {
    render(<Heading as="h2">Heading text</Heading>)
  ...
  it('should render a h3 heading', () => {
    render(<Heading as="h3">Heading text</Heading>)
  ...
  it('should render a h4 heading', () => {
    render(<Heading as="h4">Heading text</Heading>)
  ...
  it('should render a h5 heading', () => {
    render(<Heading as="h5">Heading text</Heading>)
  ...
  it('should render a h6 heading', () => {
    render(<Heading as="h6">Heading text</Heading>)
